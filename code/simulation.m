        ...
        for i_intensity = 1:length(intensities)
            ...
            if test_calibration == 1
                ...
                axial_pressure = pred_axial_pressure_opt.^2/...
                    (2*opt_res_params.medium.water.sound_speed*opt_res_params.medium.water.density).* 1e-4;
            ...
            if test_calibration == 1
                ...
                parameters.transducer.source_phase_deg = opt_source_phase_deg;
                parameters.transducer.source_phase_rad = opt_source_phase_rad;
            else
                parameters.transducer.source_amp = 83202; % use precomputed value
                parameters.transducer.source_phase_deg = 210.6;
